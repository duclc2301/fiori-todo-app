		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Todo App",
									"targetURL": "#fioritodoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioritodoapp-display": {
								"semanticObject": "fioritodoapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioritodoapp",
									"url": sap.ui.require.toUrl("fioritodoapp")
								}
							}
						}
					}
